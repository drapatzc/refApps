...
#ifndef BKKATOMIUM_SWIFT_H
#define BKKATOMIUM_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BKKAtomium",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10BKKAtomium11AppDelegate")
...
/// \param application The shared application instance.
///
/// \param launchOptions A dictionary of launch options provided by the system.
///
///
/// returns:
/// <code>true</code> to indicate successful initialization.
- (BOOL)application:(UIApplication * _Nonnull)application didFinishLaunchingWithOptions:(NSDictionary<UIApplicationLaunchOptionsKey, id> * _Nullable)launchOptions SWIFT_WARN_UNUSED_RESULT;
/// Logs the APNs device token received after successful remote-notification registration.
/// \param application The shared application instance.
///
/// \param deviceToken The unique device token assigned by APNs.
///
